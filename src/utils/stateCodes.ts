...
export const DEFAULT_SELLER_STATE: GSTStateCode = "07";
export const STATE_NAME_BY_CODE: Record<GSTStateCode, string> = {
...
const STATE_CODE_MAP: Record<string, GSTStateCode> = {
  "01": "01",
  "JAMMUANDKASHMIR": "01",
  "JAMMUKASHMIR": "01",
  "JAMMU&KASHMIR": "01",
...
export function toGSTStateCode(state: string): GSTStateCode {
...
export function getSupplyType(
  buyerState: GSTStateCode,
  sellerState: GSTStateCode
): SupplyType {
  return buyerState === sellerState ? "INTRA" : "INTER";
}

export function getStateNameFromCode(code: GSTStateCode): string {
